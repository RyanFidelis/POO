...
public class Charlesrobot extends AdvancedRobot {
    ...
    private static final double VELOCIDADE_MAXIMA = 8;
    ...
    private void circuloDeslocamento() {
        turnRight(5);
        ahead(50);
    }
    ...
    private void ajustarVelocidade(double distancia) {
